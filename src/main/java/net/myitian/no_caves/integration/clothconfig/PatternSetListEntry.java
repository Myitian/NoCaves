...
public class PatternSetListEntry
    ...
    implements ContainerEventHandler, NarratableEntry, GuiEventListener, MixinTargetMarker {
    ...
    public static class Cell
        ...
        implements ContainerEventHandler, NarratableEntry, MixinTargetMarker {
        ...
        public void extractRenderState(GuiGraphicsExtractor graphics, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean isSelected, float delta) {
            ...
            patternFieldWidget.extractRenderState(graphics, mouseX, mouseY, delta);
            flagsFieldWidget.setY(y + 1);
            flagsFieldWidget.setEditable(isEditable);
            flagsFieldWidget.extractRenderState(graphics, mouseX, mouseY, delta);
