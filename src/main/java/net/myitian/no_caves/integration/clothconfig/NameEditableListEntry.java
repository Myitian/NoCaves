...
public interface NameEditableListEntry<T> {
    ...
    static boolean drawTextFieldWidget(Object obj, GuiGraphicsExtractor graphics,
        ...
        nameFieldWidget.extractRenderState(graphics, mouseX, mouseY, delta);
        return true;
    }
    ...
    default EditBox initTextField(String name) {
        ...
        nameFieldWidget.moveCursorToStart(false);
