...
public class String2ListMapListEntry<T, INNER extends AbstractConfigListEntry<T> & NameEditableListEntry<T>> extends AbstractListListEntry<Map.Entry<String, T>, String2ListMapListEntry.Cell<T, INNER>, String2ListMapListEntry<T, INNER>> {
    ...
    @ApiStatus.Internal
    public String2ListMapListEntry(Text fieldName, @NotNull List<Map.Entry<String, T>> value, boolean defaultExpanded, Supplier<Optional<Text[]>> tooltipSupplier, Consumer<List<Map.Entry<String, T>>> saveConsumer, Supplier<Map<String, T>> defaultValue, Text resetButtonKey, boolean deleteButtonEnabled, boolean insertInFront, BiFunction<Map.Entry<String, T>, String2ListMapListEntry<T, INNER>, INNER> createNewCell) {
        super(
                fieldName,
                value,
                defaultExpanded,
    ...
    @ApiStatus.Internal
    public String2ListMapListEntry(Text fieldName, @NotNull List<Map.Entry<String, T>> value, boolean defaultExpanded, Supplier<Optional<Text[]>> tooltipSupplier, Supplier<List<Map.Entry<String, T>>> defaultValue, Consumer<List<Map.Entry<String, T>>> saveConsumer, Text resetButtonKey, boolean deleteButtonEnabled, boolean insertInFront, BiFunction<Map.Entry<String, T>, String2ListMapListEntry<T, INNER>, INNER> createNewCell) {
        super(
                fieldName,
                value,
                defaultExpanded,
